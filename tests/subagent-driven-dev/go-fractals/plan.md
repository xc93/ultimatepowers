...
Execute this plan using the `ultimatepowers:subagent-driven-development` skill.
...
**Do:**
- Initialize `go.mod` with module name `github.com/ultimatepowers-test/fractals`
