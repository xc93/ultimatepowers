...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/ultimatepowers
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/ultimatepowers-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using ultimatepowers:subagent-driven-development. The plan is at: $PLAN_PATH"
