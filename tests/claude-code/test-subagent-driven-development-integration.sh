...
mkdir -p src test docs/ultimatepowers/plans

# Create a simple implementation plan
cat > docs/ultimatepowers/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/ultimatepowers/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/ultimatepowers/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"ultimatepowers:subagent-driven-development"' "$SESSION_FILE"; then
